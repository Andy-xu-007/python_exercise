...
if os.path.isdir('test_8MN'):
    ss = os.getcwd() + '/' + 'test_8MN'
    shutil.rmtree(ss)
os.mkdir('test_8MN')
ss = os.getcwd() + '/' + 'test_8MN'
...
if not doc.is_extractable:
    ...
    module_list = {}
    module_list['RDC'] = ['49','70']
    module_list['RDC_SEMAPHORE'] = ['70','77']
    module_list['MUA'] = ['102','113']
    module_list['MUB'] = ['114','124']
    module_list['SEMA4'] = ['134','157']
    module_list['AIPSTZ'] = ['167','183']
    module_list['SPBA'] = ['192', '195']
    module_list['SJC'] = ['221', '232']

    module_list['CCM'] = ['279','494']

    module_list['CCM_ANALOG'] = ['494','556']

    module_list['GPC'] = ['581','663']

    module_list['GPC_PGC'] = ['665','689']

    module_list['XTALOSC'] = ['691','693']

    module_list['TMU'] = ['698','707']

    module_list['OCOTP'] = ['805','841']

    module_list['SNVS'] = ['850','875']

    module_list['SRC'] = ['885','916']

    module_list['WDOG'] = ['927','932']

    module_list['SDMAARM'] = ['1140','1176']

    # module_list['SDMABP'] = ['1177','1180']
    #
    # module_list['SDMACORE'] = ['1181','1198']

    module_list['IOMUXC_GPR'] = ['1224','1258']
    module_list['IOMUXC'] = ['1258','1614']

    module_list['GPIO'] = ['1619','1632']

    module_list['DDRC'] = ['1679','1834']
    module_list['DWC_DDRPHYA_ANIB'] = ['1843', '1852']
    module_list['DWC_DDRPHYA_APBONLY'] = ['1853', '1860']
    module_list['DWC_DDRPHYA_DBYTE'] = ['1861', '1916']
    module_list['DWC_DDRPHYA_DRTUB'] = ['1917', '1919']
    module_list['DWC_DDRPHYA_INITENG'] = ['1920', '1920']
    module_list['DWC_DDRPHYA_MASTER'] = ['1921', '2150']

    module_list['APBH'] = ['2159','2188']

    module_list['BCH'] = ['2219','2245']

    module_list['GPMI'] = ['2268','2295']

    module_list['ECSPI'] = ['2312','2326']
    module_list['FlexSPI'] = ['2403', '2448']

    module_list['USDHC'] = ['2511','2580']

    module_list['USBNC'] = ['2755','2777']

    module_list['USB'] = ['2777','2850']

    module_list['ENET'] = ['2869','2952']

    module_list['GPT'] = ['3026','3039']

    module_list['PWM'] = ['3044','3051']

    module_list['LCDIF'] = ['3087','3130']

    module_list['ISI'] = ['3148','3201']

    module_list['MIPI_CSI'] = ['3227','3246']

    module_list['MIPI_DSI'] = ['3273','3318']

    module_list['MIPI_DPHY'] = ['3356','3370']

    module_list['SPDIF'] = ['3384','3406']

    module_list['PDM'] = ['3413','3442']

    module_list['I2S'] = ['3475','3513']

    module_list['ASRC'] = ['3544','3597']

    module_list['I2C'] = ['3625','3631']

    module_list['UART'] = ['3673', '3702']
                ...
                for (k,v,z) in rect_valid_gat_r:  # 遍历每一个有效矩形表格,有两种函数，可以切换
                    ...
                    if df:
                        ...
                        # 分寄存器的开始,整理寄存器列表
                            ...
                            module_valid = True
                            module_ind = False
                            # the first module name IOMUXC changed to IOMUXC_GPR
                            if ModuleName_IOMUXC and (module_name == "IOMUXC"):
                                ModuleName_IOMUXC = False
                                module_name = "IOMUXC_GPR"
